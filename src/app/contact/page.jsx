        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="group block rounded-2xl p-5 backdrop-blur-md transition-all duration-300 
                               bg-gradient-to-br from-[#0D1324]/90 to-[#1B2A4A]/60
                               border border-[#F47A1F]/15 hover:border-[#F47A1F]/40
                               hover:shadow-[0_0_30px_rgba(244,122,31,0.15)]"
                  >
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-14 h-14 rounded-xl flex items-center justify-center 
                                      ...
                                      group-hover:scale-110 group-hover:border-[#F47A1F]/50
                    ...
                    return (
                      <motion.a
                        ...
                        className={`w-12 h-12 rounded-xl flex items-center justify-center
                                   ...
                                   text-[#B6BDD6] ${social.color}
                                   hover:border-[#F47A1F]/40 hover:bg-[#1B2A4A]/80
                                   transition-all duration-300`}
            ...
            <motion.div
              ...
              className="lg:col-span-3 rounded-3xl p-6 sm:p-8 backdrop-blur-md relative overflow-hidden
                         bg-gradient-to-br from-[#0D1324]/95 to-[#1B2A4A]/80
                         border border-[#F47A1F]/25 shadow-[0_20px_60px_rgba(0,0,0,0.4)]"
            >
              {/* Decorative corner */}
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        required 
                        className="h-12 rounded-xl border-[#F47A1F]/20 bg-[#070A13]/60 
                                   focus:border-[#F47A1F] focus:ring-2 focus:ring-[#F47A1F]/20
                                   text-[#F5F7FA] placeholder:text-[#8A91A8]/50 transition-all" 
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-[#B6BDD6] block">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      required 
                      className="min-h-32 rounded-xl border-[#F47A1F]/20 bg-[#070A13]/60 
                                 focus:border-[#F47A1F] focus:ring-2 focus:ring-[#F47A1F]/20
                                 text-[#F5F7FA] placeholder:text-[#8A91A8]/50 resize-none transition-all" 
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="h-12 px-8 rounded-xl font-bold flex items-center justify-center gap-2 
                                 bg-gradient-to-r from-[#F47A1F] to-[#FFB85C] text-white
                                 shadow-lg shadow-[#F47A1F]/30 hover:shadow-[#F47A1F]/50
                  ...
                  {showPopup && (
                    <motion.div
                      ...
                      className="absolute bottom-4 left-1/2 -translate-x-1/2 
                                 ...
                                 text-white shadow-lg shadow-emerald-500/30 backdrop-blur-sm"
                    >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <motion.div
            ...
            className="rounded-3xl overflow-hidden shadow-2xl relative
                       bg-gradient-to-br from-[#0D1324]/90 to-[#1B2A4A]/80
                       border border-[#F47A1F]/20 backdrop-blur-md"
          >
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* Map placeholder / Image */}
              <div className="relative h-64 lg:h-80 overflow-hidden">
                <div className="absolute inset-0 bg-[url('/hero-travel.jpg')] bg-cover bg-center" />
              ...
              <div className="p-8 lg:p-10 flex flex-col justify-center">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="mt-6 inline-flex items-center justify-center gap-2 h-11 px-6 rounded-xl
                             bg-[#1B2A4A]/80 border border-[#F47A1F]/30 text-[#F5F7FA] font-medium
                             hover:border-[#F47A1F]/60 hover:bg-[#1B2A4A] transition-all w-fit"
                >
      ...
      <section className="relative z-10 py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="max-w-4xl mx-auto text-center rounded-3xl p-8 sm:p-12 relative overflow-hidden
                       bg-gradient-to-br from-[#2A1F3F]/60 via-[#0D1324]/80 to-[#1B2A4A]/60
                       border border-[#F47A1F]/25 backdrop-blur-md
            ...
            <div className="relative z-10">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full 
                           bg-[#F47A1F]/10 border border-[#F47A1F]/30 mb-6"
              >
                <Sparkles className="w-4 h-4 text-[#FFB85C]" />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.a 
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center justify-center h-14 px-8 rounded-2xl font-bold 
                             bg-gradient-to-r from-[#F47A1F] to-[#FFB85C] text-white
